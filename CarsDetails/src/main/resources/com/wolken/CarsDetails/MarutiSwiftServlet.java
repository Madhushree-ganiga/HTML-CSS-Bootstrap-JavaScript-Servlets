...
public class  MarutiSwiftServlet extends HttpServlet {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		writer.println("<body>BMW cars price in India starts at Rs. 39.50 Lakh for X1 and goes upto "
				+ "Rs. 2.46 Crore for 7 Series. In total BMW sells 18 new car models powered by Petrol and Diesel Engines ");
